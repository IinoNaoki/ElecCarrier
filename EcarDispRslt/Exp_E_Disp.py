...
y_a_avg_bell = [RESset_bell[i][1] for i in range(expnum)]

y_v_avg_myo = [RESset_myo[i][0] for i in range(expnum)]
y_a_avg_myo = [RESset_myo[i][1] for i in range(expnum)]

y_v_avg_side = [RESset_side[i][0] for i in range(expnum)]
y_a_avg_side = [RESset_side[i][1] for i in range(expnum)]
...
plot(x_axis_list,y_a_avg_myo,color='green',linestyle='--',marker='^',label='MYO')
plot(x_axis_list,y_a_avg_side,color='black',linestyle='--',marker='s',label='SIDE')
...
plot(x_axis_list,y_v_avg_myo,color='green',linestyle='--',marker='^',label='MYO')
plot(x_axis_list,y_v_avg_side,color='black',linestyle='--',marker='s',label='SIDE')
